...
if not clinic_token:
    ...
    res2 = api("POST", "/auth/login", {"email": "owner@clinicai.com.br", "password": "ClinicOwner@2026!"})
...
print(f"   Owner: owner@clinicai.com.br / ClinicOwner@2026!")
