      ...
      <Tabs defaultValue="ai" className="space-y-6">
        ...
        <TabsContent value="whatsapp">
          <div className="space-y-4">
            ...
            {/* ── Card: Evolution API (recomendado) ── */}
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <CardTitle className="flex items-center gap-2">
                        Evolution API
                        <Badge variant="outline" className="text-green-600 border-green-300 text-xs">Recomendado</Badge>
                      </CardTitle>
                      <CardDescription>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex justify-end">
                  <Button
                    ...
                    disabled={updateClinic.isPending || (!whatsappAccessToken && whatsappPhoneNumberId === (clinic?.whatsappPhoneNumberId ?? ""))}
                    className="gap-2"
                  >
                    {updateClinic.isPending ? (
                      <Sparkles className="w-4 h-4 animate-pulse" />
